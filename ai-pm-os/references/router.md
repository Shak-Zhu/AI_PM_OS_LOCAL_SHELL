...
BRIEFING/MEETING/TODO/REPORT_DAILY/REPORT_PERIODIC/DASHBOARD_SYNC 六个 P0 专业工作流的具体行为契约与质量检查见 `references/communication-and-reporting-rules.md`。
